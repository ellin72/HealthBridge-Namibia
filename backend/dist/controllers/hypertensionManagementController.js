...
exports.getBloodPressureStatistics = exports.addMedicationLog = exports.getBloodPressureReadings = exports.addBloodPressureReading = exports.updateHypertensionProgram = exports.getHypertensionProgramById = exports.getHypertensionPrograms = exports.createHypertensionProgram = void 0;
const prisma_1 = require("../utils/prisma");
// Create hypertension management program
const createHypertensionProgram = async (req, res) => {
    try {
        const userId = req.user.id;
        const { providerId, diagnosisDate, targetBP, medications, lifestyleGoals, } = req.body;
        const program = await prisma_1.prisma.hypertensionManagementProgram.create({
            data: {
                patientId: userId,
                providerId,
...
exports.createHypertensionProgram = createHypertensionProgram;
// Get patient's hypertension programs
const getHypertensionPrograms = async (req, res) => {
    try {
        const userId = req.user.id;
        ...
        const programs = await prisma_1.prisma.hypertensionManagementProgram.findMany({
            where,
            include: {
                _count: {
                    select: {
...
exports.getHypertensionPrograms = getHypertensionPrograms;
// Get hypertension program by ID
const getHypertensionProgramById = async (req, res) => {
    try {
        const userId = req.user.id;
        const { id } = req.params;
        const program = await prisma_1.prisma.hypertensionManagementProgram.findFirst({
            where: {
                id,
                patientId: userId,
            },
...
exports.getHypertensionProgramById = getHypertensionProgramById;
// Update hypertension program
const updateHypertensionProgram = async (req, res) => {
    try {
        const userId = req.user.id;
        const { id } = req.params;
        const { targetBP, medications, lifestyleGoals, status, } = req.body;
        const program = await prisma_1.prisma.hypertensionManagementProgram.findFirst({
            where: {
                id,
                patientId: userId,
        ...
        const updated = await prisma_1.prisma.hypertensionManagementProgram.update({
            where: { id },
            data: {
...
exports.updateHypertensionProgram = updateHypertensionProgram;
// Add blood pressure reading
const addBloodPressureReading = async (req, res) => {
    try {
        const userId = req.user.id;
        const { programId, systolic, diastolic, heartRate, readingContext, medicationTaken, notes, } = req.body;
        ...
        const reading = await prisma_1.prisma.bloodPressureReading.create({
            data: {
                programId,
                systolic,
                diastolic,
...
const getBloodPressureReadings = async (req, res) => {
    try {
        const userId = req.user.id;
        ...
        const readings = await prisma_1.prisma.bloodPressureReading.findMany({
...
const addMedicationLog = async (req, res) => {
    try {
        ...
        const log = await prisma_1.prisma.hypertensionMedicationLog.create({
            data: {
                programId,
                medicationName,
                dosage,
...
exports.addMedicationLog = addMedicationLog;
// Get blood pressure statistics
const getBloodPressureStatistics = async (req, res) => {
    try {
        const userId = req.user.id;
        ...
        let inRangeCount = null;
        if (targetBP && targetBP.systolic !== undefined && targetBP.diastolic !== undefined) {
            const tolerance = 10; // ±10 mmHg tolerance
            inRangeCount = readings.filter((r) => Math.abs(r.systolic - targetBP.systolic) <= tolerance &&
                Math.abs(r.diastolic - targetBP.diastolic) <= tolerance).length;
        }
            ...
            inRangeCount = readings.filter((r) => (!targetBP.systolicMin || r.systolic >= targetBP.systolicMin) &&
                (!targetBP.systolicMax || r.systolic <= targetBP.systolicMax) &&
                (!targetBP.diastolicMin || r.diastolic >= targetBP.diastolicMin) &&
                (!targetBP.diastolicMax || r.diastolic <= targetBP.diastolicMax)).length;
        }
        const stats = {
...
exports.getBloodPressureStatistics = getBloodPressureStatistics;
//# sourceMappingURL=hypertensionManagementController.js.map