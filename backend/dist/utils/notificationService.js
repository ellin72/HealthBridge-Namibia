...
exports.sendReceiptSMS = sendReceiptSMS;
...
async function sendReceiptEmail(receiptData) {
    try {
        ...
        await prisma_1.prisma.receipt.updateMany({
 ...
 */
async function sendPaymentConfirmation(userId, amount, currency, method, transactionId) {
    try {
 ...
 */
function generateReceiptSMS(data) {
