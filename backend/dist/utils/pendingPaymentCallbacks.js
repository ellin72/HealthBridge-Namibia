...
exports.storePendingCallback = storePendingCallback;
exports.peekPendingCallback = peekPendingCallback;
exports.getPendingCallback = getPendingCallback;
exports.removePendingCallback = removePendingCallback;
exports.cleanupExpiredCallbacks = cleanupExpiredCallbacks;
 ...
 */
function getCallbackKey(paymentReference, transactionId) {
    if (paymentReference) {
 ...
 */
function storePendingCallback(paymentReference, transactionId, status, metadata) {
 ...
 */
function peekPendingCallback(paymentReference, transactionId) {
    const key = getCallbackKey(paymentReference, transactionId);
    if (!key) {
        return null;
    }
 ...
 */
function getPendingCallback(paymentReference, transactionId) {
 ...
 */
function removePendingCallback(paymentReference, transactionId) {
    const key = getCallbackKey(paymentReference, transactionId);
    if (key) {
        pendingCallbacks.delete(key);
...
//# sourceMappingURL=pendingPaymentCallbacks.js.map