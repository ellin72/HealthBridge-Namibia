...
export const generateResearchTopic = async (req: AuthRequest, res: Response) => {
  try {
...
export const createResearchTopic = async (req: AuthRequest, res: Response) => {
  try {
...
export const getResearchTopics = async (req: AuthRequest, res: Response) => {
  try {
    const userId = req.user!.id;
...
export const getResources = async (req: AuthRequest, res: Response) => {
  try {
    ...
    const resources = await prisma.researchResource.findMany({
      where,
      orderBy: { createdAt: 'desc' }
    });
...
export const requestSupervisor = async (req: AuthRequest, res: Response) => {
  try {
    ...
    const match = await prisma.supervisorMatch.create({
      data: {
        studentId: userId,
        supervisorId,
        field,
...
export const getSupervisorRequests = async (req: AuthRequest, res: Response) => {
  try {
    const userId = req.user!.id;
    const userRole = req.user!.role;
    const { status } = req.query;
    ...
    const requests = await prisma.supervisorMatch.findMany({
      where,
      include: {
        student: {
          select: {
...
export const respondToSupervisorRequest = async (req: AuthRequest, res: Response) => {
  try {
    const { id } = req.params;
    ...
    const match = await prisma.supervisorMatch.findUnique({
      where: { id }
    });
    ...
    const updated = await prisma.supervisorMatch.update({
      where: { id },
      data: updateData,
      include: {
        student: {
...
export const updateCollaboration = async (req: AuthRequest, res: Response) => {
  try {
    ...
    const collaboration = await prisma.researchCollaboration.findUnique({
      where: { id }
    });
    ...
    const updated = await prisma.researchCollaboration.update({
      where: { id },
      data: updateData
    });
...
export const deleteCollaboration = async (req: AuthRequest, res: Response) => {
  try {
    ...
    await prisma.researchCollaboration.delete({
      where: { id }
    });
